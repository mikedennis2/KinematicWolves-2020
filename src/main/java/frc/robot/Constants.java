...
public final class Constants {
    ...
    public static final int BALL_INDEX_SENSOR_2_DI_NUM = 8;
    public static final int BALL_INDEX_SENSOR_3_DI_NUM = 7;
    public static final int BALL_INDEX_SENSOR_4_DI_NUM = 6;
